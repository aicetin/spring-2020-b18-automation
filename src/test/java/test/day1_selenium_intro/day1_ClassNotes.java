...
- Two types of tags
1- Paired tag; aka(Also Known As)- non-self closing
...
2- Unpaired tag; aka(Also Known As)- SELF CLOSING TAGS
syntax : <tagName/> usually has some attribute and value to provide further information about the tag
ex:
<input type="text">
<img src="" />
...
syntax: <tag attribute="attributeValue"/>
